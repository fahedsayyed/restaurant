...
function onchange(){
var mealss = document.getElementById("meals").value;
localStorage.setItem("name",mealss);
var position = document.getElementById("position").value;
localStorage.setItem("no. of people",position);
var restaurantss=document.getElementById("restaurant").value;
localStorage.setItem("restaurant",restaurantss);
};
